...
export abstract class recipe{
    constructor(
        ...
        private ingridientsRecord: Record<string, number>,
    ...
    public getIngridientsRecord(): Record<string, number>{
        return this.ingridientsRecord;
    }

    public setIngridientsRecord(ingridientsRecord: Record<string, number>){
